...
export default function RecommendationsPage() {
    ...
    const fetchRecs = (p, sid, isSurprise = false) => {
        ...
        getRecommendations({
            ...
            .then(result => { setData(result); setSessionId(result.session_id); setLoading(false) })
            .catch(() => { toast.error('Could not connect to AI engine. Is the backend running?'); setLoading(false) })
    }
